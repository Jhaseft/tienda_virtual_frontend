      ...
      <div className="flex items-start justify-between gap-2">
        <div className="min-w-0 flex-1">
          ...
          <p className="truncate text-xs text-zinc-500">
            {customer.phoneNumber || customer.email || "Sin contacto"}
          </p>
          {lastOrder ? (
            <p className="mt-0.5 text-xs text-zinc-400">Último pedido: {lastOrder}</p>
          ) : null}
        </div>

        <div className="flex shrink-0 items-center gap-2">
          <div className="text-right">
            <p className="text-xs text-zinc-500">{customer.totalOrders} pedidos</p>
          ...
          {customer.phoneNumber ? (
            <a
              ...
              className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-emerald-500 text-white hover:bg-emerald-600 active:scale-95 transition-transform"
            >
